...
class FinancialResearchPresentationTests(unittest.TestCase):
    ...
    def test_routes_and_accessible_chart_fallbacks_are_present(self):
        ...
        self.assertIn("Same-quarter seasonality", page_source)
        self.assertIn("Quarter contribution by year", page_source)
        self.assertIn("Within-sector visual screen", page_source)
        self.assertIn("Reviewed comparison gates", page_source)
        ...
        self.assertIn("Exact filings reviewed", page_source)
        self.assertIn("Evidence gates applied", page_source)
        self.assertIn("Exact-filing findings", page_source)
